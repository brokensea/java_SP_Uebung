...
public class Main {
    ...
    // System.out.println(
    // "Top-Kunde: " + topKunde.getName() + " mit " +
    // topKunde.getTotalReservationStunden() + " Stunden.");
    ...
    // } else {
    // System.out.println("Es gibt keine Boote oder alle Boote haben keine
    // Reservierungen.");
    // }
    // }
    ...
    // Reservation reservation1 = new Reservation(person1, from1, to1,
    // boot1.getId(), boot1);
    ...
    // Reservation reservation2 = new Reservation(person2, from2, to2,
    // boot2.getId(), boot2);
    ...
    // // Call boatWithHighestRevenue to find the boot with highest revenue in the
    // last
    // // 7 days
    // Boot highestRevenueBoot = bootsverleih.boatWithHighestRevenue(7);

    // if (highestRevenueBoot != null) {
    // System.out.println("Boot with highest revenue: " +
    // highestRevenueBoot.getId());
    // } else {
